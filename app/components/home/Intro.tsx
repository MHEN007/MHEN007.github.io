      ...
      <div className="flex flex-col sm:mt-5 w-full md:w-[50%] mt-10 md:mt-0 gap-10">
        <div id="about">
          ...
          <div className="text-sm md:text-lg">
            Hello! I&apos;m Matthew Mahendra, but you can call me Mahen. I&apos;m an IT business analyst and a software engineer. I graduated from Bandung Institute of Technology in Informatics Engineering/Computer Science with Cum Laude.
